            ...
            <div className="px-6 py-4 w-full h-[96%] flex flex-col justify-start overflow-y-scroll scrollbar-thin scrollbar-thumb-primeColor">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-2 text-gray-400">
                  ...
                  <p className="text-sm">
                    I agree to the{" "}
                    <span className="text-primeColor hover:underline underline-offset-2 decoration-[1px] cursor-pointer">
                      Terms & Conditions
                    </span>
                  </p>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link to="/signin">
                    <p className="text-sm text-primeColor hover:underline underline-offset-2 decoration-[1px] cursor-pointer">
                      Sign in
                    </p>
                  </Link>
                </div>
